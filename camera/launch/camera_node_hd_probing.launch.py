...
def generate_launch_description():
    ...
    #we don't want depth and neither res switch
    camera_hd_gripper = Node(
        ...
        namespace='/HD',
        parameters=[
            {'camera_type': "oakd_stereo_probing"},
            ...
            {'fps_internal': [30, 30]},
            {'fps_external': [30, 30]},
            {'rgb_resolution': ["1080P", "1080P"]},
            {'mono_resolution': ["0P", "0P"]},
            {'flip_camera': False},
            {'fps_depth': [0, 0]},  
            {'number_of_frames_to_average': [0, 0]},
