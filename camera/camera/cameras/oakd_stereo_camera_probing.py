...
class OakDStereoCameraProbing:
    def __init__(self, node):
        ...
        self.node.declare_parameter("max_exposure_us", 10600) #4600 for ERC during the day
    ...
    def _build_pipeline(self):
        ...
        if self.monoResolution != 0:
            ...
            depthOut.input.setQueueSize(1)
        
        for xout in (rgbOut, rgbExtOut):
